...
def load_data():
    data_path = 'Dataset/predicted_data.csv'
...
def show_prediction(): 
    ...
    # Header
    st.title(f"Flood Monitoring Dashboard (Predicted Data)")
    ...
    with col2:
        ...
        fig_yearly = px.area(yearly_data, x='Year', y='Water Level', color='Location', title="Yearly Total Water Levels")
